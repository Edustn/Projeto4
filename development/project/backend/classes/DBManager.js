...
module.exports = class DBManager {
    ...
    /**
     * Function that made a consult in the given DB
     * @param {String} sql 
     * @param {String} mode 
     * @param {Array} values 
     * @returns {Promise(resolve(queryResult), reject(Error))} 
    ...
    /**
     * Function to select data from gived database
     * @param {String} query 
     * @param {Array} values 
     * @returns {Promise(resolve(queryResult), reject(Error))} 
     */
    ...
    /**
     * Function that made a insert sql and return it
     * @param {String} table 
     * @param {Array} columns 
     * @param {Array} values 
     * @returns {Promise(resolve(queryResult), reject(Error))}
     */
    doInsertSql(table, columns, values) {
    ...
    /**
     * Function which insert data in gived database
     * @param {String} table 
     * @param {Array} columns 
     * @param {Array} values 
     * @returns {Promise(resolve(queryResult), reject(Error))} 
    ...
    insert(table, columns, values) {
        /**
         * For multiple inserts with just one argument or for just an one insert,
         * the values arguments shoulde be send in this way:
         * [value_1, value_2, value_3]
         * 
         * Otherwise, for inserts with multiple fields, the values argument should be send in that way:
         * [[value_1, value_2, value_3], [value_1, value_2, value_3], [value_1, value_2, value_3]]
         * Each array inside that array is an insert.
         */
        let sql = this.doInsertSql(table, columns, values);
    ...
    /**
     * Function that updates data in gived database
     * @param {String} table 
     * @param {Object} data 
     * @param {String} where 
     * @returns {Promise(resolve(queryResult), reject(Error))} 
